...
def fetch_game_details(game_id):
    ...
    try:
        ...
        tk.Button(results_inner_frame, text="← Back",
                  command=show_previous_results).grid(row=0, column=0, sticky="w")
...
tk.Button(top_frame, text="Search", command=fetch_game_data_by_name).pack(side="left")
tk.Button(top_frame, text="Clear", command=clear_search).pack(side="left")
